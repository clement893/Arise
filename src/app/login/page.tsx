        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-[#D4A84B] hover:bg-[#c49a42] text-white font-semibold rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center gap-2 py-3 bg-white rounded-lg text-gray-700 font-medium hover:bg-gray-100 transition-colors"
              >
              ...
              <button
                type="button"
                className="flex items-center justify-center gap-2 py-3 bg-black rounded-lg text-white font-medium hover:bg-gray-900 transition-colors"
              >
